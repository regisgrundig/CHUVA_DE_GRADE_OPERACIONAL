...
for loop=1:size(BRUTOS)
    arquivo=BRUTOS(loop).name;
    if (mod(i,1000)==0)
    arquivo;
    end
    dt=datenum(arquivo(35:45),'YYYYmmdd');
    indice=dt-DATA_INICIAL;
    ...
    DADOS(:,:,indice)=Z(110:200,560:660);
    LON=X(110:200,560:660);
